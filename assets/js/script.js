...
document.addEventListener('DOMContentLoaded', function () {
  ...
  for (const button of clickedButtons) {
    button.addEventListener('click', function () {
      ...
      const playerImageShake = document.getElementById('player-hand')
      const computerImageShake = document.getElementById('computer-hand')
...
function generateComputerChoice () {
  const computerChoiceArray = ['rock-computer', 'lizard-computer', 'paper-computer', 'scissors-computer', 'spock-computer']
  const i = Math.floor(Math.random() * computerChoiceArray.length)
  const computerChoiceI = computerChoiceArray[i]
 ...
 */
function rulesMenu () {
  const rulesSpan = document.getElementsByClassName('rules-span')[0]
  const rulesList = document.getElementsByClassName('rules-list')[0]
...
function checkWinner (playerChoice, computerChoice) {
  const ruleElement = document.getElementById('winner-rule-point')
  const scorePlayer = document.getElementById('player-score')
  const scoreComputer = document.getElementById('computer-score')
  const numberOfMatches = document.getElementById('matches-counter')
...
function displayGameImage (playerChoice, computerChoice) {
  ...
  const playerImageElement = document.getElementById('player-hand')
  const computerImageElement = document.getElementById('computer-hand')
  // Player choices
...
function calculateTheWinner () {
  const numberOfMatchesCalculate = parseInt(document.getElementById('matches-counter').textContent)
  const scorePlayerCalculate = parseInt(document.getElementById('player-score').textContent)
  const scoreComputerCalculate = parseInt(document.getElementById('computer-score').textContent)
...
function resetGame () {
  ...
  const resetWinnerRule = document.getElementById('winner-rule-point')
  ...
  const playerImageReset = document.getElementById('player-hand')
  playerImageReset.src = 'assets/images/icon-rock-player.svg'

  const computerImageReset = document.getElementById('computer-hand')
